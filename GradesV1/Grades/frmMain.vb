...
Public Class frmMain
    ...
    Private Sub btnReport_Click(sender As Object, e As EventArgs) Handles btnReport.Click
        FileOpen(1, "report.txt", OpenMode.Output)
        PrintLine(1, "Summary Report Created: " + DateTime.Now.ToString("dddd, MMMM dd, yyyy"))
        WriteLine(1)
        PrintLine(1, "Class Average: " + ClassAverage.ToString)
        WriteLine(1)
        WriteLine(1)
        'function to loop through array of studentRecord objects
        For i As Integer = 0 To 17
            PrintLine(1, listOfStudentRecords(i).FirstName + " " + listOfStudentRecords(i).LastName + " " + listOfStudentRecords(i).Assignment1.ToString + " " +
